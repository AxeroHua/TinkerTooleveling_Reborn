...
public class TinkerLeveling {
    ...
    public TinkerLeveling(FMLJavaModLoadingContext context) {
        IEventBus modEventBus = context.getModEventBus();
        MODIFIERS.register(modEventBus);
        modEventBus.addListener(TinkerLeveling::registerSoundEvent);
        MinecraftForge.EVENT_BUS.register(this);
        context.registerConfig(ModConfig.Type.COMMON, TinkerConfig.COMMON_CONFIG, "tcleveling.toml");
        TinkerPacketHandler.register();

        instance = this;
    }

    private static final ResourceLocation CAPABILITY_KEY = ResourceLocation.fromNamespaceAndPath(TinkerLeveling.MODID, "entityxp");
    ...
    public static final ResourceLocation SOUND_LEVELUP_LOCATION = ResourceLocation.fromNamespaceAndPath(TinkerLeveling.MODID, "levelup");

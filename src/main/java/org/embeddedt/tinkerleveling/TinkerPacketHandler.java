...
public class TinkerPacketHandler {
    ...
    public static final SimpleChannel INSTANCE = NetworkRegistry.newSimpleChannel(
            ResourceLocation.fromNamespaceAndPath(TinkerLeveling.MODID, "main"),
            () -> PROTOCOL_VERSION,
    ...
    public static void sendLevelUp(int level, Player player, Component toolName) {
    ...
    static class LevelUpMessage {
        ...
        static LevelUpMessage decode(FriendlyByteBuf buf) {
            ...
            Component toolName = buf.readComponent();
            LevelUpMessage msg = new LevelUpMessage();
            msg.level = level;
            msg.toolName = toolName;
            return msg;
        ...
        void handle(Supplier<NetworkEvent.Context> ctx) {
            ctx.get().enqueueWork(() ->
                    ...
                    DistExecutor.unsafeRunWhenOn(Dist.CLIENT, () -> () -> ClientHelper.sendLevelUpMessage(level, toolName))
            );
